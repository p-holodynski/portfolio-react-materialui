...
class SectionTwo extends Component {
    render(){
        return (
            <Grid container id='section-two' direction="row" justify="center" alignItems="center" style={{backgroundColor: '#d6dde3', paddingBottom: '80px'}}>
                <Grid item xs={12}>
                    <Typography variant="h3" component="h3" align="center" style={{fontFamily: 'Roboto Slab', fontSize: "1.5em", padding: "20px 0px 40px 0px"}}>
